    ...
    div.right {
		...
		<section style="width: 80%">
			...
			<div class="panel panel-default">
				...
				<form action="/admin/editLib.do" method="post"  >
					
				<div class="mb-3">
  					<label for="exampleFormControlInput1" class="form-label">도서관 이름(Title)</label>
  						<input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="${lib.name }">
				</div>
				<div class="mb-3">
  					<label for="exampleFormControlInput2" class="form-label">주소(address)</label>
  						<input type="text" class="form-control" id="sample4_roadAddress" name="address" value="${lib.address }">
				...
				<div class="mb-3">
  					<label for="exampleFormControlInput3" class="form-label">전화번호</label>
  						<input type="text" class="form-control" id="exampleFormControlInput2" name="phone" value="${lib.phone }">
				</div>
				 <div class="mb-3">
  					<label for="exampleFormControlInput4" class="form-label">홈페이지(url)</label>
  						<input type="text" class="form-control" id="exampleFormControlInput3" name="url" value="${lib.url }">
				</div>
				<div class="mb-3">
  					<label for="exampleFormControlTextarea5" class="form-label">도서관 종류(type)</label>
 					<textarea class="form-control" id="exampleFormControlTextarea4" rows="3" name="type">${lib.type}</textarea>
				</div>
				...
				<input type="hidden" name="no" value="${lib.no}"> 
